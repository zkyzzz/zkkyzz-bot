function help() {
    return `
*_Assalamualaikum, Halo!_*
*_Dengan Zkyzzz Project's BOT Disini!!! Gunakanlah Bot Sebijak Mungkin;))_*
*_Berikut Fitur - Fitur Yang Bisa Kalian Gunakan_*

Menu Group:
1. *!add* _628xxxxxxxxxx_

1. *!kick* _@tagMember_

2. *!promote* _@tagMember_
...
2. *!fb* _post/video url_

3. *!ig* _instagram post url_

Others:
  Menu Sticker Creator:
1. *!sticker*

2. *!sticker* _Url Gambar_

3. *!stikerGif* _Giphy URL_ / *!stickergif* _Giphy URL_

4. *!stickernobg* _Gambar_

5. *!neko*

6. *!pokemon*

7. *!jadwalShalat* _namaKota_

8. *!jadwalTv* _namaChannel_

9. *!cuaca* _namaKota_

10. *!tts* _kodeBhs_ _teks_

11. *!igStalk* _@username_

12. *!wiki* _query_

13. *!brainly* _pertanyaan_ _.jumlahJawaban_
...
22. *!quoteMaker* _|teks|author|theme_
...
Source code bot : https://github.com/zkyzzz/zkkyzz-bot

Base source code bot : https://github.com/mhankbarbar/whatsapp-bot

Owner Bot : wa.me/6282112540160 a.k.a Zaky

Oh iya om, bot ini gratis ya, soalnya saya lihat banyak yang jual bot² kayak gini, tapi ini gratis kok.`
}
exports.info = info()
function snk() {
    return `Syarat dan Ketentuan Bot *Zkyzzz Project*
