...
module.exports = msgHandler = async (client, message) => {
	...
	case '!stickernobg':
		...
		//untuk api key kalian bisa dapatkan pada website remove.bg
                var result = await removeBackgroundFromImageBase64({ base64img, apiKey: 'MvWFuoHMhcmnPYMSHotoHCL8', size: 'auto', type: 'auto', outFile })
        ...
        case '!bc':
            ...
            for (let ids of chatz) {
                ...
                if (!cvk.isReadOnly) await client.sendText(ids, `[ Zkyzzz BOT Broadcast ]\n\n${msg}`)
            }
